            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="/data-mobil/update/{{$data->id}}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('patch')
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" class="form-control" value="{{$data->nama_mobil}}"
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Tempat
                                        duduk</label>
                                    <div class="col-sm-12 col-md-7">
                                        <input type="number" class="form-control" min="2" max="10"
                                            value="{{$data->tempat_duduk}}" name="tempat_duduk">
                                        @error('tempat_duduk')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                {{-- <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Bahan
                                        Bakar</label>
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" class="form-control" value="{{$data->bahan_bakar}}"
                                            name="bahan_bakar">
                                        @error('bahan_bakar')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="number" min="50000" max="1000000" class="form-control" name="harga"
                                            value="{{$data->harga}}">
                                        @error('harga')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="number" min="50000" max="10000000" class="form-control"
                                            name="denda" value="{{$data->denda}}">
                                        @error('denda')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <select name="transmisi" class="form-control selectric">
                                            ...
                                            <option {{$data->transmisi == 'manual' ? 'selected' : ''}} value="manual">Manual</option>
                                            <option {{$data->transmisi == 'semi-otomatis' ? 'selected' : ''}} value="semi-otomatis">Semi Otomatis</option>
                                            <option {{$data->transmisi == 'otomatis' ? 'selected' : ''}} value="otomatis">Otomatis</option>
                                        </select>
                                        @error('transmisi')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <select name="type_id" class="form-control select2">
                                            ...
                                            <option {{ $item->id == $data->type_id ? 'selected' : ''}}
                                                value="{{$item->id}}">{{$item->nama_tipe}}</option>
                                            @endforeach
                                        </select>
                                        @error('type_id')
                                        <div class="text-danger">{{ $message }}</div>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <select class="form-control select2" multiple name="fitur[]">
                                            ...
                                            <option value="{{$fitem->id}}" @foreach ($data->fiturs as $fiturId)
                                                @if ($fitem->id == $fiturId->id)
                                                selected
                                                @endif
                                                @endforeach
                                                >{{$fitem->nama_fitur}}</option>
                                            @endforeach
                                        </select>
                                        @error('fitur')
                                        <div class="text-danger">{{ $message }}</div>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <select name="sopir" class="form-control selectric">
                                            <option disabled selected>Silahkan pilih</option>
                                            <option {{$data->sopir == 'ready' ? 'selected' : ''}} value="ready">Ada
                                            </option>
                                            <option {{$data->sopir == 'tidak' ? 'selected' : ''}} value="tidak">Tidak
                                            </option>
                                        </select>
                                        @error('sopir')
                                        <div class="text-danger">{{ $message }}</div>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <select name="status" class="form-control selectric">
                                            <option disabled selected>Silahkan pilih</option>
                                            <option {{$data->status == 'ready' ? 'selected' : ''}} value="ready">Ready
                                            </option>
                                            <option {{$data->status == 'tidak' ? 'selected' : ''}} value="tidak">Tidak
                                            </option>
                                        </select>
                                        @error('status')
                                        <div class="text-danger">{{ $message }}</div>
